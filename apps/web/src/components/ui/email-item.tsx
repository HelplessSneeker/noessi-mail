...
export function EmailItem({ email, isSelected, onClick }: EmailItemProps) {
  ...
  return (
    <div
      className={cn(
        "border-b border-gray-100 p-4 cursor-pointer transition-all duration-200 ease-out relative email-item",
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-2">
              ...
              {email.isStarred && (
                <svg className="w-4 h-4 text-yellow-400 fill-current transition-all duration-200 hover:scale-110" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                </svg>
              )}
              {email.hasAttachments && (
                <svg className="w-4 h-4 text-gray-400 transition-all duration-200 hover:text-gray-600 hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-500 whitespace-nowrap transition-colors duration-200">
          ...
          <div className="mb-1">
            <span className={cn(
              "text-sm block truncate transition-colors duration-200",
          ...
          {/* Preview */}
          <div className="text-xs text-gray-500 line-clamp-2 transition-colors duration-200">
